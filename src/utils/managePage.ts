...
/**
 * Runs in the document head before paint so a hard load of a manage page
 * gets `html.manage-page` without waiting for hydration.
 * Keep this in sync with `isManagePagePath`.
 */
