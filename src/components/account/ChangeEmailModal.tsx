      ...
      >
        ...
        >
          ...
          <div className="flex-shrink-0 flex items-start justify-between gap-4 p-4 pb-0">
            <h2 className="text-2xl font-bold max-sm:text-xl">Change email address</h2>
            <button
              type="button"
              onClick={handleClose}
              ...
              {success ? (
                <div className="text-center py-4">
                  ...
                  <p className="text-foreground/70 text-sm">
                    ...
                    Click the link to confirm changing your email to <strong className="text-foreground">{newEmail}</strong>.
                  </p>
                </div>
              ) : (
                <>
                  ...
                  {error && <ErrorMessage variant="compact">{error}</ErrorMessage>}
