...
function DeleteAccountModalContent({ stats, onDeleted }: DeleteAccountModalContentProps) {
  ...
  }, [isDeleting, modalContext]);

  useEffect(() => {
    modalContext.setBeforeCloseCheck(() => !isDeleting);
    return () => modalContext.setBeforeCloseCheck(null);
  }, [modalContext, isDeleting]);
...
export default function DeleteAccountSection({ stats }: DeleteAccountSectionProps) {
  ...
  const openDeleteModal = () => {
    ...
    modalContext.setTitle('Delete your account');
    modalContext.setFooter(null);
    modalContext.setContent(
      <DeleteAccountModalContent
        stats={stats}
        onDeleted={() => router.push('/account-deleted')}
      />,
    );
