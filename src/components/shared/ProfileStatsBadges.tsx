    ...
    <div className="">
      ...
      <div className="grid gap-3 grid-cols-2 sm:grid-cols-5">
        {badges.map((badge, index) => (
          <div key={index} className="badge-gradient rounded-md px-3 py-4 flex flex-col items-center text-center shadow-xl shadow-foreground/3 hover:shadow-primary/20 dark:hover:shadow-primary-alt/20 transition-all duration-300">
            <div className="mb-2">
