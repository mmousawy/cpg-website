...
function ActivityCard({ activity }: { activity: typeof activities[0] }) {
  ...
  return (
    <div
      className={`group flex h-full items-start gap-3 rounded-xl border p-4 transition-all hover:shadow-sm ${styles.card}`}
    >
      <div
      ...
      >
        ...
        <p
          className="text-md text-foreground/80 mt-1"
        >
...
export default function ActivitiesSlider() {
  ...
  return (
    <>
      ...
      <noscript>
        <div
          className="grid gap-4 px-4 sm:grid-cols-2 lg:grid-cols-3"
        >
      ...
      >
        <noscript>
          <style>
            {'.js-only-slider { display: none !important; }'}
          </style>
        </noscript>
