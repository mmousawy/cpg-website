...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 flex justify-center border-b-[0.0625rem] border-b-border-color border-t-primary bg-background-light px-4 py-2 text-foreground shadow-md shadow-[#00000005]">
      <div className={clsx(
