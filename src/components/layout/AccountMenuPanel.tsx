        ...
        <div className="p-2">
          {showNotificationsEntry && onOpenNotifications && (
            ...
            >
              ...
              Notifications
              {unseenCount > 0 && (
                <span className="ml-auto rounded-full bg-red-700 px-1.5 py-0.5 text-[10px] font-medium text-white">
          ...
          <Link href="/account/events" prefetch={false} onClick={onClose} className={menuLinkClass('/account/events')}>
            <svg className="mr-3 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            My events
          </Link>
          <Link href="/account/challenges" prefetch={false} onClick={onClose} className={menuLinkClass('/account/challenges')}>
            <svg className="mr-3 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
            </svg>
            My challenges
          </Link>
          <Link href="/account/photos" prefetch={false} onClick={onClose} className={menuLinkClass('/account/photos')}>
            <svg className="mr-3 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {isAdmin && (
            <Link href={routes.admin.url} prefetch={false} onClick={onClose} className={menuLinkClass(routes.admin.url)}>
              <svg className="mr-3 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
