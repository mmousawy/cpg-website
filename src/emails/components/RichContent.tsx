...
const INLINE_STYLES: Record<string, string> = {
  ...
  ul: 'margin: 8px 0; padding-left: 16px; font-size: 14px; line-height: 1.65em; color: #171717;',
  ol: 'margin: 8px 0; padding-left: 16px; font-size: 14px; line-height: 1.65em; color: #171717;',
  li: 'margin: 4px 0;',
