      ...
      <Tailwind>
        <Body className="m-auto bg-[#f7f7f7] p-2 font-sans">
          <Container className="mx-auto max-w-[465px] border-separate rounded-lg border border-solid border-[#e5e7ea] bg-white p-5">
            ...
            <Section className="my-[20px]">
              <Link href={entityLink}>
                <Row>
                  ...
                  <Column className={entityThumbnail ? "pl-4 align-top" : "align-top"}>
            ...
            <Section className="my-[20px] rounded-lg border border-[#e5e7ea] bg-[#f7f7f7] p-4">
              <Row>
                ...
                <Column className="pl-3 align-top">
                  {commenterProfileLink ? (
                    <Link href={commenterProfileLink} className="text-[#171717] no-underline">
                      <Text className="my-0! mb-1! text-[14px] font-semibold leading-[20px] text-[#171717]">
                        {commenterName}
                      </Text>
                    </Link>
                  ) : (
                  ...
                  {commenterNickname && (
                    commenterProfileLink ? (
                      <Link href={commenterProfileLink} className="text-[#666666] no-underline">
                        <Text className="my-0! mb-2! text-[12px] leading-[16px] text-[#666666]">
                          @{commenterNickname}
                        </Text>
                      </Link>
                    ) : (
                  ...
                  <Text className="my-0! text-[14px] leading-[20px] text-[#171717] whitespace-pre-wrap">
                    {displayComment}
                  </Text>
                </Column>
              </Row>
            ...
            <Footer fullName={ownerName} optOutLink={optOutLink} emailType="notifications" />
          </Container>
        </Body>
      </Tailwind>
    </Html>
