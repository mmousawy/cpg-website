export default function About() {
  return (
    <section className="flex justify-center border-t-[0.0625rem] border-t-border-color bg-background-light p-6 text-foreground sm:p-12">
      <div className="max-w-screen-sm">
        <h2 className="mb-4 font-[family-name:var(--font-geist-mono)] text-2xl font-bold leading-tight">What&apos;s Creative Photography Group?</h2>
        <p className="mb-5">
